...
namespace LM
{
    ...
    // IMPLEMENT THIS!!!
    DataBase* Loader_0_0_1::LoadDataBase(std::ifstream &fin)
    {
        std::string line;
    ...
    Homestead* Loader_0_0_1::LoadHomestead(std::ifstream &fin)
    {
    ...
    MembershipFee* Loader_0_0_1::LoadMembershipFee(std::ifstream& fin)
    {
    ...
    Electricity* Loader_0_0_1::LoadElectricity(std::ifstream& fin)
    {
    ...
    int Loader_0_0_1::GetInt(std::string_view str)
    {
        int temp = 0;
    ...
    Date Loader_0_0_1::GetDate(std::string_view str)
    {
        Date temp;
        char trash;
        std::istringstream iss (str.data());
