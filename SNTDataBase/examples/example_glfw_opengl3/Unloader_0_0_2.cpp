...
namespace LM
{
    ...
    bool Unloader_0_0_2::SaveDataBase(DataBase* database)
    {
        std::ofstream fout;
    ...
    void Unloader_0_0_2::SaveHomestead(Homestead &homestead, std::ofstream &fout)
    {
        ...
        fout << homestead.m_HasBenefits << std::endl;

        fout << homestead.m_AddMembershipFees << std::endl;
    ...
    void Unloader_0_0_2::SaveMembershipFee(MembershipFee &membershipFee, std::ofstream &fout)
    {
    ...
    void Unloader_0_0_2::SaveElectricity(Electricity& electricity, std::ofstream& fout)
    {
    ...
    void Unloader_0_0_2::SaveStaticDate(DataBase* database, std::ofstream& fout)
    {
