...
namespace LM
{
    ...
    public:
        ...
        struct EditWindowMF
        {
            MembershipFee* MS = nullptr;
            Homestead* SelectedHomestead = nullptr;
            Payment* Editable = nullptr;
            Payment Intermediate;
            bool Create = false;
            bool Dirty = false;

            virtual void CreateNewIntermediate(Payment* editable, MembershipFee* ms)
            {
                if (Create)
                    return;
    ...
    protected:
        ...
        //static inline uint32_t MAJOR = 0;
        //static inline uint32_t MINOR = 0;
        //static inline uint32_t PATCH = 0;
        ...
        //std::vector<ColumnsInfo*> ColumnsVector{ &HomesteadColumn, &MembershipFeeColumn, &MembershipFeeOpeningBalanceColumn,  };
